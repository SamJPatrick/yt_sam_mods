...
BIN_DENSITY = 20
LOG_PLOT = False
OUTDIR = "Profiles_pop3/Velocity_profiles_lin"



def all_profiles(ap, bin_density, log_prof, outdir='.'):
    ...
    my_kwargs = pkwargs.copy()
    my_kwargs["logs"] = {x_bin_field: log_prof}
...
if __name__ == "__main__":
    ...
    ap.add_recipe(all_profiles, bin_density, log_prof, outdir= OUTDIR)
