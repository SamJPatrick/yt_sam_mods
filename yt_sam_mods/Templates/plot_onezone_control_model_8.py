...
if __name__ == "__main__":
    ...
    my_axes.plot(ed_time, ed_data["data", "density"], color=ecolor, label="data")
    my_axes.plot(model_time, model_data["data", "density"], color=mcolor, label="model")

    t_ratio = model_data["data", "freefall_time"] / model_data["data", "sound_crossing_time"]
    ...
    my_cbar = mpl.colorbar.ColorbarBase(my_cax, cmap=my_cmap, norm=my_norm, orientation='vertical')
