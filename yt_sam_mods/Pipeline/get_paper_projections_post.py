...
my_fig = multi_image(panels, "paper_projections_pisn.png", figsize=(8, 6.7), fontsize=12, dpi=200,
                     n_columns=3, bg_color="white", text_color="black",
                     tick_range = RANGE, tick_label = 'pc', n_ticks = 7,
                     cbar_orientation='horizontal',
                     bottom_buffer=0.12, top_buffer=0.12, left_buffer=0.10, right_buffer=0.10)
my_fig = multi_image(panels, "paper_projections_pisn.pdf", figsize=(8, 6.7), fontsize=12, dpi=200,
                     n_columns=3, bg_color="white", text_color="black",
                     tick_range = RANGE, tick_label = 'pc', n_ticks = 7,
                     cbar_orientation='horizontal',
                     bottom_buffer=0.12, top_buffer=0.12, left_buffer=0.10, right_buffer=0.10)
...
my_fig = multi_image(panels, "paper_slices.pdf", figsize=(8, 6.7), fontsize=12, dpi=200,
                     n_columns=3, bg_color="white", text_color="black",
                     tick_range = RANGE, tick_label = 'pc', n_ticks = 7,
                     cbar_orientation='horizontal',
                     bottom_buffer=0.12, top_buffer=0.12, left_buffer=0.10, right_buffer=0.10)
my_fig = multi_image(panels, "paper_slices.png", figsize=(8, 6.7), fontsize=12, dpi=200,
                     n_columns=3, bg_color="white", text_color="black",
                     tick_range = RANGE, tick_label = 'pc', n_ticks = 7,
                     cbar_orientation='horizontal',
                     bottom_buffer=0.12, top_buffer=0.12, left_buffer=0.10, right_buffer=0.10)
